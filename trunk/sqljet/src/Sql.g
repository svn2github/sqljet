...
fragment ID_QUOTED_CORE: ~(QOUTE_DOUBLE | APOSTROPHE | LPAREN_SQUARE | RPAREN_SQUARE);
fragment ID_QUOTED_CORE_DOUBLE: (ID_QUOTED_CORE | LPAREN_SQUARE | RPAREN_SQUARE | APOSTROPHE)*;
fragment ID_QUOTED_CORE_SQUARE: (ID_QUOTED_CORE | QOUTE_DOUBLE | APOSTROPHE)*;
fragment ID_QUOTED_CORE_APOSTROPHE: (ID_QUOTED_CORE | LPAREN_SQUARE | RPAREN_SQUARE | QOUTE_DOUBLE)*;
...
fragment ID_QUOTED: ID_QUOTED_DOUBLE | ID_QUOTED_SQUARE | ID_QUOTED_APOSTROPHE;
